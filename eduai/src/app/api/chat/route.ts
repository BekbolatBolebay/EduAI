        ...
        messages: [
          {
            ...
            Сенің жауаптарың Gemini сияқты әдемі, құрылымдалған және көрнекі болуы керек:
            - Маңызды сөздерді **қалың қаріппен** (bold) белгіле.
            - Тізімдерді (bullet points) қолдан.
            - Тақырыпшаларды (headings) қолдан.
            - Көбірек эмодзилер (🚀, ✨, 📚, 💡) қолдан.
            - Түсіндірулерді қарапайым әрі қызықты етіп жаз.
